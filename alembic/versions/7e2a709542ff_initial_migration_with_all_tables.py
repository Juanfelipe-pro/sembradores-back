...
def upgrade():
    ...
    # Crear tipos ENUM antes de crear las tablas que los usan
    op.execute(sa.text("""
        DO $$ BEGIN
    ...
    sa.Column('tipo', postgresql.ENUM('basico', 'premium', 'premium_anual', name='tipoplan', create_type=False), nullable=False),
    ...
    sa.Column('estado', postgresql.ENUM('pendiente', 'aprobado', 'rechazado', 'cancelado', name='estadopago', create_type=False), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
...
def downgrade():
    ...
    op.execute("DROP TYPE IF EXISTS tipoplan")
    # ### end Alembic commands ###
